# -*- coding: utf-8 -*-
"""
Created on Fri Dec 17 13:46:28 2021
...
def split_data(all_reviews,Data):
    CV = CountVectorizer(min_df=3)#Đếm các vector nhiều nhất là 3 từ giống nhau
    x = CV.fit_transform(all_reviews).toarray()#fit các vector với all_reviews
